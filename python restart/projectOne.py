...
What the task is suppose to do is properly make a program that can take survey information
from a user. By using and understanding oommenting, output, variables.
...
'''
text_to_user = input ("What is your name?")
name = text_to_user
print (name)

text_to_user = input ("What is your favorite color?")
color = text_to_user
print (color)

text_to_user = input ("What city did you grow up in?")
city= text_to_user 
print (city)

text_to_user = input ("What is your best friend's name?")
friend= text_to_user
print (friend)

text_to_user = input ("What color hair do you have?")
colorHair = text_to_user
print (colorHair)
